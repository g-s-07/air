# Generated by Django 5.0.2 on 2024-02-20 09:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveBigIntegerField(choices=[(1, 'flightstaff'), (2, 'security'), (3, 'admin')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_no', models.ForeignKey(default=1007, on_delete=django.db.models.deletion.CASCADE, to='flights.flight')),
            ],
        ),
        migrations.CreateModel(
            name='Security',
